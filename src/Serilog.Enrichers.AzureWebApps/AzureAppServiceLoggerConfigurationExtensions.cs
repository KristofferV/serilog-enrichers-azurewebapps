...
namespace Serilog
{
    ...
    public static class AzureAppServiceLoggerConfigurationExtensions
    {
        ...
        /// <param name="enrichmentConfiguration">Enrichment configuration to complete.</param>
        /// <returns>Logger configuration with this enricher configured.</returns>
        public static LoggerConfiguration WithAzureWebJobsName(this LoggerEnrichmentConfiguration enrichmentConfiguration)
        {
            if (enrichmentConfiguration == null)
                throw new ArgumentNullException(nameof(enrichmentConfiguration));
        ...
        /// <param name="enrichmentConfiguration">Enrichment configuration to complete.</param>
        /// <returns>Logger configuration with this enricher configured.</returns>
        public static LoggerConfiguration WithAzureWebJobsType(this LoggerEnrichmentConfiguration enrichmentConfiguration)
        {
            if (enrichmentConfiguration == null)
                throw new ArgumentNullException(nameof(enrichmentConfiguration));
